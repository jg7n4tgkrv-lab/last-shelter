...
const ITEM_DB = {
  ...
  cloth_wrap:  { name: "Stoffwicklung", type: "armor", bonus: 3, rarity:"common", icon:"🧣" },
  leather:     { name: "Lederrüstung", type: "armor", bonus: 6, rarity:"uncommon", icon:"🥾" },
  ...
  crafted_armor: { name: "Grobe Rüstung", type: "armor", bonus: 3, rarity:"common", icon:"🛡️" },
