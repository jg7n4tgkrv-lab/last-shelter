...
const ITEM_ICON_FILES = {
  ...
  old_compass: "images/icons/compass.png"
};
...
const ITEM_DB = {
  ...
  old_compass: { name: "Alter Kompass", type: "accessory", rareLootBonus: 0.2, rarity:"rare", icon:"🧭" }
};
